...
global $beanList;
global $beanFiles;
$s_panle = array('dg_store_ppg_review_meetings','dg_store_training_meetings',
...
global $sugar_config;
$old_entry = $sugar_config['list_max_entries_per_subpanel'];
if (in_array($_REQUEST['subpanel'],$s_panle)) {
    $sugar_config['list_max_entries_per_subpanel'] = 1000;	
}
$subpanel_object->display();

$sugar_config['list_max_entries_per_subpanel'] = $old_entry;
//var_dump('mmmeeeetttting');
if(empty($_REQUEST['inline']))
{
