...
REM
set PHPBIN="C:\php53_win\php-win.exe"
set bin_dir="C:\Users\anru\Documents\NetBeansProjects\Minifier\vendor\phpunit\phpunit"
...
:RUN
"%PHPBIN%" "C:\Users\anru\Documents\NetBeansProjects\Minifier\vendor\phpunit\phpunit\phpunit.php" %*
